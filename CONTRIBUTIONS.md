...
---
 ...
 > **Before Submitting**
      ...
      - **Test your changes thoroughly**:
         - Test in runner.html
         - Export to NexArt format if applicable
...
---
 ...
 > **Before Creating an Issue**
      ...
      - **Gather relevant information**:
         ...
         - Browser and version (for visual issues)
         - Steps to reproduce
 ...
 > **Issue Types**
      - **Bug Reports**:
         ...
         - **Environment**:
            ...
            - Node.js: [e.g., 20.10.0]
            - pnpm: [e.g., 8.15.0]
         - **Screenshots/Logs** - If applicable, add screenshots or relevant logs
      - **Feature Requests**:
...
---
 ...
 > **Creating New Sketches**
   ...
   - **Test export early**:
      ...
      ```
 > **Utility Libraries**
   - **When adding to src/art/lib/**:
      - Keep functions pure - No side effects
      - Document parameters - Clear JSDoc comments
      - Add TypeScript types - Full type coverage
      - Consider performance - These run every frame
      - Write examples - Show usage in comments
